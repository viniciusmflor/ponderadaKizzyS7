...
Usuario digita a idade dele

Se a idade do usuário for menor que 16, ele nao pode votar

Se a idade do usuário for maior que 16 e menor que 18, o voto é facultativo

Se a idade do usuário nao for menor que 16 e nao for menor que 18, o voto é obrigatório
______
...
Resposta: Classe Retangulo que herda de FormaGeometrica. 

Atributos: - herda o atributo cor da classe pai (super), 

Método Construtor(cor): Define o valor da cor com o valor passado como parametro, 
Método CalcularArea parametros: largura e altura, retorna largura multiplicado pela altura```  
...
Método Construtor(cor): Define o valor da cor com o valor passado como parametro, 
Método CalcularArea parametros: raio, retorna 3,14 multiplicado pelo raio elevado ao quadrado
...
Enquanto tempoDecorrido <= tempoMaximo:
    velocidadeAtual += aceleracao * tempoDecorrido
    Se velocidadeAtual > velocidadeMaxima:
        velocidadeAtual = velocidadeMaxima
        
    tempoEstimado = distancia / velocidadeAtual
    
    Se tempoEstimado > tempoMaximo:
        Retornar "O carro não pode completar a corrida dentro do tempo máximo permitido."
    
    Se tempoDecorrido >= tempoEstimado:
        Retornar tempoDecorrido
    tempoDecorrido++
...
Função MultiplicacaoDeMatrizes(matrizA, matrizB):
    ...
    Senão:
        ...
        # Loop para iterar cada elemento da matriz resultado e calcular a multiplicação
